...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F3] text-[#1A1A1A] font-body selection:bg-[#2558D9] selection:text-white overflow-x-hidden">
      ...
      {/* SECTION 7 — FOOTER */}
      <footer className="py-20 px-6 border-t border-[#E2DED6]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          <div>
            ...
            <p className="mt-6 text-sm text-[#8C8881] font-medium leading-loose">
              New Delhi & Gurgaon, India <br />
              @infoasktech
            </p>
          </div>
          <div className="text-sm font-bold text-[#8C8881]">
            © 2026 ASK Tech. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
